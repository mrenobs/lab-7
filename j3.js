document.addEventListener("DOMContentLoaded", () => {
    fetch("https://raw.githubusercontent.com/ironhack-jc/mid-term-api/main/projects")
        ...
        .then(data => {
            const proyecto1 = data.find(proyecto => proyecto.uuid === "3");
            if (proyecto1) {
                mostrarProyecto(proyecto1);
            } else {
                alert("El proyecto con UUID 3 no existe en la API.");
            }
        })
        .catch(error => {
...
function mostrarProyecto(proyecto) {
    const container = document.getElementById("projects-container3");
